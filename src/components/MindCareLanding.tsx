...
import logoM from '../img/logo.jpg'
      ...
      <nav className="bg-white shadow-sm p-4">
        <div className="max-w-6xl mx-auto flex justify-between items-center">
          <div className="flex items-center space-x-2">
            ...
            <Image
              src={logoM} // Ruta de la imagen
              alt="MindCare Logo" // Texto alternativo
              width={40} // Ancho del logo
              height={40} // Alto del logo
              className="rounded-full" // Clases de Tailwind
            />
      ...
      <section className="py-20 px-4">
        <div className="max-w-6xl mx-auto text-center">
          ...
          <div className="flex flex-col md:flex-row justify-center gap-4">
            <Button className="bg-teal-600 hover:bg-teal-700 text-lg flex items-center justify-center px-8 py-6">
              Programa tu primera sesión
              <ArrowRight className="ml-2" />
            </Button>
            <Button variant="outline" className="text-lg  flex items-center justify-center px-8 py-6">
